    ...
    <div className="p-8 h-full flex flex-col gap-8 overflow-hidden bg-black/10">
      ...
      <div className="grid grid-cols-12 gap-8 flex-1 min-h-0">
        ...
        <div className="col-span-7 flex flex-col gap-4 min-h-0">
          ...
          <Panel title="Event Sequencing" className="flex-1">
          ...
          <AnimatePresence mode="wait">
            {selectedTrade ? (
              <motion.div 
                ...
                className="h-full"
              >
                <Panel title="Transaction Receipt" className="h-full" glow="green-glow">
                  <div className="p-8 flex flex-col h-full relative">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      ...
                      <div>
                        <h3 className="text-lg font-black tracking-tighter uppercase">Receipt Verified</h3>
